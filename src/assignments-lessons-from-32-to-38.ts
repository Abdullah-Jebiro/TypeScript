...
//https://elzero.org/typescript-assignments-lessons-from-32-to-38/
//assignment 01
{
// Do Not Edit
...
function showTypes<T=void,A=void,B=void>(item1:T| string = "Nothing",item2:A| string = "Nothing",item3:B| string = "Nothing"):string{
